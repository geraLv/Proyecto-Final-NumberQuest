...
//     return(
//         <div>
//             <h1>Composicion de Funciones :3</h1>
//             <h1>Actividad 1 OwO</h1>
//             <p>Nombre: {nombre}</p>
//             Considera los siguientes conjuntos:
//             <ul>
//                 <li> <p> Conjunto A:{'{1,2,3}'} </p> </li>
//                 <li> <p> Conjunto B:{'{4,5,6}'} </p> </li>
//                 <li> <p> Conjunto C:{'{7,8,9}'} </p> </li>
//                 <p> Define 2 relaciones</p>
//             </ul>
//             <h1> R1: {respuesta}</h1>
//             <h1> R2: {respuesta} </h1>
