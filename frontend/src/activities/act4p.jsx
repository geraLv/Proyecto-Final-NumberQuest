...
import imgguia5 from "../public/img/guiaact5.png"
  ...
  return (
    <div className="justify-start w-full h-full">
      <div className="container flex flex-col w-full h-full">
        ...
        <br />
        El logaritmo natural esta definido solo por valores mayores a 0, por lo tanto el argumento debe ser positivo
        <br />
        <br />
        <div className="flex">
        ...
        <br />
        <div className="flex">
          <h1 className="text-black text-2xl">Entonces el valor de x en el logaritmo es mayor que 3 o menor que -3</h1>
        </div>
        <br />
        <h1 className="text-black text-2xl">Dominio del denominador (x^2 - 4)</h1>
        <br />
        x^2 - 4 Distinto de 0
        <br />
        <br />
        ...
        {openHelp ? (
          <div>
            <div className="container border-2 border-blue-gray-400 rounded p-3 my-3 bg-gray-200">
              ...
              <br />
              <h1 className="text-black text-xl">Resolvemos esta desigualdad:</h1>
              <br />
              <div className="flex">
                {/* <h1 className="text-light-blue-900 text-2xl">=></h1>{" "} */}
