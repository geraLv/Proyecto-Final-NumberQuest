...
export function Button({ selectedValue }) {
  ...
  return <button onClick={sendResponse}>Responder :v</button>;
}
...
export function InputResponse({ answer1, answer2 }) {
  ...
  validar === true ? ActivitiesStatus(true) : ActivitiesStatus(false);

  console.log(valueActivitie);
  return (
    <>
      <div>
        <input type="text" id="response1" placeholder="xx/-xx" maxLength={5} />
        <span>---</span>
        <input type="text" id="response2" placeholder="xx/-xx" maxLength={5} />
      </div>
